                    ...
                    <div class="page-title-box">
                        <div class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Lead Priority</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Lead Priority</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body mb-n3">
                            <button class="btn btn-outline-primary btn-sm px-4 mt-0 mb-3" wire:click="addLeadPriority()" type="button" >
                                <span wire:loading wire:target="addLeadPriority">
                                    <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                </span>
                                <span wire:loading.remove wire:target="addLeadPriority">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($leadPriorities as $lp)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td> {{ $lp->name }}</td>
                                                <td> {!! getStatus($lp->is_visible) !!}</td>
                                                <td> {{ $lp->created_at }}</td>

                                                <td class="text-end">
                                                    <a href="javascript:;" wire:click="edit({{ $lp->id }})"><i class="las la-pen text-secondary font-16 text-info"></i></a>
                                                    <a href="javascript:;" onclick="confirmDeletion({{ $lp->id }})"><i class="las la-trash-alt text-secondary font-16 text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title m-0" id="exampleModalDefaultLabel"> {{ $modalMode === 'edit' ? 'Edit Lead Priority' : 'Cretae Lead Priority' }}</h6>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="mb-3">
                                    <label for="doj" class="mb-2">Priorty<span style="color: red;">*</span></label>
            ...
            @else
                <form wire:submit.prevent="createLeadPriority" class="needs-validation">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                    ...
                    <div class="modal-footer">
                        <button type="button" wire:click="closeModal" class="btn btn-outline-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-outline-primary btn-sm">
                            <span wire:loading wire:target="createLeadPriority">
                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...
                            </span>
                            <span wire:loading.remove wire:target="createLeadPriority">
                                Save changes
                            </span>
                        </button>
                    </div><!-- end modal-footer -->
