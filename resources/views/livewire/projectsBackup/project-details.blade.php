<div class="page-wrapper">
    ...
    <div class="page-content-tab">
        ...
        <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="text-center">
                                <img class="me-3 rounded-circle thumb-xl" src="assets/images/users/user-4.jpg"
                                    alt="">
                                <div class="">
                                ...
                                <p class="text-muted px-3">Contrary to popular belief, Lorem Ipsum is not simply random
                                    text.
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="media align-items-center mb-3">
                                <span
                                    class="thumb-xs justify-content-center d-flex align-items-center bg-soft-warning rounded-circle fw-semibold">A</span>
                            ...
                            <div class="media align-items-center mb-3">
                                <span
                                    class="thumb-xs justify-content-center d-flex align-items-center bg-soft-purple rounded-circle fw-semibold">F</span>
                                <div class="media-body ms-3 align-self-center">
                            ...
                            <div class="media align-items-center mb-3">
                                <span
                                    class="thumb-xs justify-content-center d-flex align-items-center bg-soft-pink rounded-circle fw-semibold">B</span>
                                <div class="media-body ms-3 align-self-center">
                                    ...
                                    <div class="progress mt-0" style="height:3px;">
                                        <div class="progress-bar bg-pink" role="progressbar" style="width: 45%;"
                            ...
                            <div class="media align-items-center">
                                <span
                                    class="thumb-xs justify-content-center d-flex align-items-center bg-soft-success rounded-circle fw-semibold">T</span>
                                <div class="media-body ms-3 align-self-center">
            ...
            <div class="row mb-3">
                <div class="col-lg-6">
                    <h5 class="d-inline-block me-2">🏆 COD's availabel team members.</h5>
