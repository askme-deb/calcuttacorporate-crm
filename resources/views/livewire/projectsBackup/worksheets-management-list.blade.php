                ...
                <div class="col-lg-6 text-end">
                    <div class="text-end">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item" x-data="{ open: false }"
                                x-init="$wire.on('closeDropdown', () => { open = false })">
                                ...
                                <div x-show="open" @click.away="open = false" class="dropdown-menu show" style="position: absolute;">
                                    <a href="javascript:;" class="dropdown-item" wire:click="setProjectType('')">All</a>
                                    @foreach ($jobtypes as $jobid => $jobname)
                                    <a href="javascript:;" class="dropdown-item" wire:click="setProjectType({{ $jobid }})">{{ $jobname }}</a>
                                    @endforeach
                                </div>
                            </li>
                            <li class="list-inline-item" x-data="{ open: false }"
                                ...
                                <!-- Dropdown menu (visible when 'open' is true) -->
                                <div x-show="open" @click.away="open = false" class="dropdown-menu show" style="position: absolute;">
                                    <a href="javascript:;" class="dropdown-item" wire:click="setView('list')">List View</a>
                                    <a href="javascript:;" class="dropdown-item" wire:click="setView('grid')">Grid View</a>
                                </div>
                            </li>
