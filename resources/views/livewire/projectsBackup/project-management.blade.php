<div class="page-wrapper">
    ...
    <div class="page-content-tab">
                ...
                <div class="col-lg-6 text-end">
                    <div class="text-end">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item">
                                <a href="{{ route('project.create')}}" wire:navigate class="btn btn-primary btn-sm">Add New Project</a>
                            </li>
                        </ul>
                    </div>                            
                </div><!--end col-->
        ...
        <div class="offcanvas offcanvas-end d-block" tabindex="-1" id="Appearance" aria-labelledby="AppearanceLabel" style="background: rgba(0, 0, 0, .6);">
