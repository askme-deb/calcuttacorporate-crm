                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header bg-primary text-white">
                                                <h4 class="card-title  text-white">List of Required Documents</h5>
                                            </div>
                                            <div class="card-body">
                                                <ul class="list-unstyled ps-3 mb-0">
                                                    @foreach(getListOfDocuments($work_id) as $document)
                                                    <li class="mb-2">
                                                        <i class="far fa-folder me-1 text-warning"></i>
                                                        <strong>{{ $document->name }}</strong>

                                                        @if ($document->children && $document->children->count())
                                                        <ul class="list-unstyled ps-4">
                                                            @foreach ($document->children as $child)
                                                            <li>
                                                                <i class="far fa-folder-open me-1 text-secondary"></i>
                                                                {{ $child->name }}
                                                            </li>
                                                            @endforeach
                                                        </ul>
