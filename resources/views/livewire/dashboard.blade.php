<div class="page-wrapper">
    ...
    function renderChart(dealsData) {
        ...
        var options = {
            ...
            series: [
                { name: "New Deals", data: totalDeals },
                { name: "Closed Deals", data: closedDeals }
            ],
            xaxis: {
        ...
        if (chartContainer) {
            ...
            Livewire.on("dealsUpdated", function(updatedData) {
                ...
                chart.updateSeries([
                    { name: "New Deals", data: updatedTotalDeals },
                    { name: "Closed Deals", data: updatedClosedDeals }
                ]);
            });
        }
    }
