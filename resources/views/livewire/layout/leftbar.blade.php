    ...
    <div class="main-icon-menu">
        ...
        <div class="pro-metrica-end">
            <a href="{{ route('profile')}}" class="profile">
                <img src="{{empProfilePicture(auth()->id())}}" alt="profile-user"
    ...
    <div class="main-menu-inner">
        <div class="topbar-left">
            <a href="{{ route('dashboard') }}" class="logo">
                <span>
                    <img src="{{ asset('assets/images/logo.jpeg') }}" alt="logo-large" class="logo-lg logo-dark" style="height:36px;">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="logo-large" class="logo-lg logo-light">
                </span>
            </a>
        </div>
        <div class="menu-body navbar-vertical tab-content" data-simplebar wire:ignore>
            <div id="codHr" class="main-icon-menu-pane tab-pane {{ request()->routeIs('employee.*', 'edit-employee', 'attendance.*') ? 'active show' : '' }}" role="tabpanel" aria-labelledby="hr-tab">
                <div class="title-box">
                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse {{ request()->routeIs('employee.*', 'edit-employee') ? 'show' : '' }}" id="sidebarEmployee">
                                <ul class="nav flex-column">
                                    @can('Create Employee')
                                    <li class="nav-item">
                                        <a wire:navigate href="{{ route('create-employee') }}" class="nav-link">Add New Employee</a>
                                    </li>
                                    @endcan
                                    @can('View Employee')
                                    <li class="nav-item">
                                        <a wire:navigate href="{{ route('employee') }}" class="nav-link {{ request()->routeIs('employee.*', 'edit-employee') ? 'active' : '' }}">Employee
                                            List</a>
                                    </li>
                                    @endcan
                                </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarAttendance">
                                <ul class="nav flex-column">
                                    ...
                                    <!--</li>-->
                                    <!--<li class="nav-item">-->
                                    <!--    <a class="nav-link" href="#">Employee Log</a>-->
                                    <!--</li>-->
                                    @can('View Attendance')
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse " id="sidebarLeave">
                                <ul class="nav flex-column">
                                    ...
                                    @endcanany
                                    @canany(['Create Leave Type', 'View Leave Type', 'Edit Leave Type', 'Delete Leave Type'])
                                    <li class="nav-item">
            ...
            <div id="codFinance" class="main-icon-menu-pane  tab-pane" role="tabpanel" aria-labelledby="fin-tab">
                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse_2">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="pages-gallery.html">Banks</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="pages-gallery.html">Invoice</a>
                        </li>
                        <li class="nav-item">
            ...
            @endcanany
            @canany(['Create Project', 'View Project', 'Edit Project', 'Delete Project', 'Asign Project', 'Create Lead', 'Edit Lead', 'View Lead', 'Delete Lead', 'Create Deal', 'View Deal', 'Edit Deal', 'Delete Deal'])
            <div id="codProjects" wire:ignore
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('project.dashboard') }}">Dashboard</a>
                    </li>
                            ...
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->routeIs('leads') ? 'active' : '' }}"
                                        href="{{ route('leads') }}" wire:navigate>All Leads</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse {{ request()->routeIs('deal') ? 'show' : '' }}"
                            id="sidebarDeals">
                            <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse {{ request()->routeIs('project.create', 'worksheet','completedworksheet', 'project.edit', 'tasks') ? 'show' : '' }}"
                            ...
                            <ul class="nav flex-column">
                                ...
                                <!--</li>-->
                                    <!-- Dynamic Project Status Wise Pages -->
                                    @php
                                        $workStatuses = \App\Models\WorkStatus::where('is_visible', 1)->get();
                                    @endphp
                                    @foreach($workStatuses as $status)
                                        <li class="nav-item">
                                            <a class="nav-link {{ request()->routeIs('project.status') && request('status') == $status->name ? 'active' : '' }}"
                                                href="{{ route('project.status', ['status' => $status->name]) }}" wire:navigate>{{ $status->name }}</a>
                                        </li>
                                    @endforeach
                                @endcan
                    ...
                    @endcanany
                     ...
                     @canany(['View Reports'])
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('workreport') ? 'active' : '' }}"
                            href="{{ route('workreport') }}">Works Report</a>
                    </li>
                     @endcanany
            ...
            <div id="codSettings" wire:ignore class="main-icon-menu-pane tab-pane
            {{ request()->routeIs('users.*', 'user.edit', 'role.*', 'permissions.*','permissions.asign') ? 'active show' : '' }}"
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <div class="collapse {{ request()->routeIs('users.*','user.edit') ? 'show' : '' }}" id="sidebarSettings">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->routeIs('users.*','user.edit') ? 'active' : '' }}" href="{{ route('users') }}" wire:navigate>Users</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse {{ request()->routeIs('permissions.*','permissions.asign') ? 'show' : '' }}" id="sidebarProject">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link " href="{{ route('role') }}" wire:navigate>Roles</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->routeIs('permissions.*','permissions.asign') ? 'active' : '' }}" href="{{ route('permissions') }}">Permissions</a>
                                </li>
                                    ...
                                    <div class="collapse " id="sidebarWorkListMaster">
                                        <ul class="nav flex-column">
                                            <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                <a class="nav-link" href="{{ route('documentlist') }}" wire:navigate>
                                                    List of Documents</a>
                                            </li>
                                                <li class="nav-item">
                                                <a class="nav-link" href="{{ route('documentlistmap') }}" wire:navigate>Work
                                                    Document Map</a>
                                            </li>
