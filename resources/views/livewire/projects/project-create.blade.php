                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div wire:ignore>
                                                <textarea id="pro-message" class="form-control editor" rows="5"
...
function initTinyMCE() {
    // Destroy previous instances (prevents double editors)
    tinymce.remove();
    ...
    tinymce.init({
        ...
        promotion: false,  // hides the upgrade message
...
// On SPA navigation (wait for DOM to render)
document.addEventListener('livewire:navigated', () => {
    setTimeout(() => {
        if (document.querySelector('#pro-message')) {
            initTinyMCE();
        }
