                    ...
                    <div class="page-title-box">
                        <div class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a wire:navigate href="{{ route('invoices') }}">Invoices</a>
                                </li>
                                <li class="breadcrumb-item active">Create New Invoice</li>
                            </ol>
                        </div>
                        <h4 class="page-title">GST Invoice </h4>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <ul class="suggestions">
                                                ...
                                                <li
                                                    wire:click="selectItem({{ $index }}, {{ $suggestion->id }})">
                                                    {{ $suggestion->name }}
                                        ...
                                        @if ($this->customer_state == 'West Bengal')
                                        <td>{{ isset($items[$index]['cgst']) ? number_format($items[$index]['cgst'], 2) : '0.00' }}
                                        </td>
                                        <td>{{ isset($items[$index]['sgst']) ? number_format($items[$index]['sgst'], 2) : '0.00' }}
                                        </td>
                                        @else
                                        <td>{{ isset($items[$index]['igst']) ? number_format($items[$index]['igst'], 2) : '0.00' }}
                                        </td>
                                        @endif
                                        </td>
                                    ...
                                    <div class="total-payment p-3 mt-4">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                @if ($this->customer_state == 'West Bengal')
                                                <tr>
                                                    <td class="fw-semibold">CGST</td>
                                                    <td>₹{{ number_format($cgst, 2) }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="fw-semibold">SGST</td>
                                                    <td>₹{{ number_format($sgst, 2) }}</td>
                                                </tr>
                                                @else
                                                <tr>
                                                    <td class="fw-semibold">IGST</td>
                                        ...
                                        <!-- <div class="form-check mt-3">
                                            <input class="form-check-input" type="checkbox" id="advancePaymentCheck" wire:model="advance_payment">
