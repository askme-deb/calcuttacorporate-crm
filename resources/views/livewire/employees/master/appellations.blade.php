            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Appellation</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body mb-n3">
                            <button class="btn btn-outline-primary btn-sm px-4 mt-0 mb-3" wire:click="addAppellation()" type="button" >
                                <span wire:loading wire:target="addAppellation">
                                    <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                </span>
                                <span wire:loading.remove wire:target="addAppellation">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($appellations as $appli)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td> {{ $appli->name }}</td>
                                                <td> {!! getStatus($appli->is_visible) !!}</td>
                                                <td> {{ $appli->created_at }}</td>

                                                <td class="text-end">
                                                    <a href="javascript:;" wire:click="edit({{ $appli->id }})"><i class="las la-pen text-secondary font-16 text-info"></i></a>
                                                    <a href="javascript:;" onclick="confirmDeletion({{ $appli->id }})"><i class="las la-trash-alt text-secondary font-16 text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title m-0" id="exampleModalDefaultLabel"> {{ $modalMode === 'edit' ? 'Edit Appellation' : 'Cretae Appellation' }}</h6>
            ...
            @else
                <form wire:submit.prevent="createAppellation" class="needs-validation">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                    ...
                    <div class="modal-footer">
                        <button type="button" wire:click="closeModal" class="btn btn-outline-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-outline-primary btn-sm">
                            <span wire:loading wire:target="createAppellation">
                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...
                            </span>
                            <span wire:loading.remove wire:target="createAppellation">
                                Save changes
                            </span>
                        </button>
                    </div><!-- end modal-footer -->
