                    ...
                    <div class="page-title-box">
                        <div class="float-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Appointed Organisation</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Appointed Organisation</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body mb-n3">
                            <button class="btn btn-outline-primary btn-sm px-4 mt-0 mb-3" wire:click="addOrg()" type="button" >
                                <span wire:loading wire:target="addOrg">
                                    <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                                </span>
                                <span wire:loading.remove wire:target="addOrg">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($organisations as $org)
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td> {{ $org->name }}</td>
                                                <td> {!! getStatus($org->is_visible) !!}</td>
                                                <td> {{ $org->created_at }}</td>

                                                <td class="text-end">
                                                    <a href="javascript:;" wire:click="edit({{ $org->id }})"><i class="las la-pen text-secondary font-16 text-info"></i></a>
                                                    <a href="javascript:;" onclick="confirmDeletion({{ $org->id }})"><i class="las la-trash-alt text-secondary font-16 text-danger"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title m-0" id="exampleModalDefaultLabel"> {{ $modalMode === 'edit' ? 'Edit Organisation' : 'Cretae Organisation' }}</h6>
            ...
            @else
                <form wire:submit.prevent="createOrg" class="needs-validation">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                    ...
                    <div class="modal-footer">
                        <button type="button" wire:click="closeModal" class="btn btn-outline-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-outline-primary btn-sm">
                            <span wire:loading wire:target="createOrg">
                                <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Loading...
                            </span>
                            <span wire:loading.remove wire:target="createOrg">
                                Save changes
                            </span>
                        </button>
                    </div><!-- end modal-footer -->
