<div class="page-wrapper">
    ...
    <div class="page-content-tab">
        <div class="container-fluid">
            ...
            <form wire:submit.prevent="updateEmployee" id="form-validation-2" enctype="multipart/form-data">
            <div class="row">
                <div class="col-lg-9">
                    <div class="card">
                        <div class="card-header bg-primary">
                            <h4 class="card-title text-light">Employee Details Below</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" wire:model="eng_letter" class="form-control" id="engageFile">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label for="appointedOrganisation">Appointed Organisation</label>
                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-grid">
                                    ...
                                    @else
                                    <div class="preview-box d-block justify-content-center rounded shadow overflow-hidden bg-light p-1">
                                        <img class="rounded d-block" src="{{ $userimage }}" style="height: 172px;width: 100%;">
                                    </div>
